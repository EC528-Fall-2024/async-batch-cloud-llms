class CountData:
    def __init__(self, total_count, batch_processor_count, reverse_batch_processor_count, rate_limiter_count, queue_1_count, queue_2_count):
        ...
        self.queue_1_count = queue_1_count
        self.queue_2_count = queue_2_count
    ...
    def from_dict(source):
        ...
        return CountData(
            ...
            queue_1_count=source.get("queue_1_count", 0),
            queue_2_count=source.get("queue_2_count", 0)
